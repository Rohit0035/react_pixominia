                ...
                <nav className={`navbar navbar-expand-lg menu_one ${mClass}`}>
                    <div className={`container ${cClass}`}>
                        <Link className={`navbar-brand ${slogo}`} to="/">
                            ...
                            <img src={require("../img/logo.png")} alt="logo" width="200px"/>
                        </Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className={`navbar-nav menu ml-auto ${nClass}`}>
                                ...
                                <li className="nav-item"><NavLink title="Pricing" className="nav-link" to="/Contact">Sell Your Content</NavLink></li>
                            ...
                            <a className={`btn_get btn_hover ${hbtnClass}`} href="#get-app">Sign Up</a>
                            
                            <a className={`btn_get btn_hover rt ${hbtnClass}`} href="#get-app">Login</a>
                        </div>
                    </div>
                </nav>
                </header>
